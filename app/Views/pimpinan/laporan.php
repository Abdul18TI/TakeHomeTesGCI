...
<head>
    ...
    <link rel="stylesheet" href="<?= base_url() ?>/template/node_modules/flag-icon-css/css/flag-icon.min.css">
            ...
            <div class="main-sidebar sidebar-style-2">
                <aside id="sidebar-wrapper">
                    ...
                    <ul class="sidebar-menu">
                        ...
                        <li class="active"><a class="nav-link" href="/"><i class="fas fa-file"></i> <span>Tagihan</span></a></li>
                </aside>
            </div>
            <!-- Main Content -->
                            ...
                            <div class="col-12 col-sm-12 col-lg-12">
                                <div class="card">
                                    <div class="card-header">
                                        <h4>Laporan pembayaran tagihan</h4>
                                    </div>
                                    <div class="card-body">
    ...
    var myChart = new Chart(ctx, {
        ...
        data: {
            datasets: [{
                ...
                label: 'Laporan pembayaran tagihan'
            }],

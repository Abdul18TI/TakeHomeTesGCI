                    ...
                    <ul class="sidebar-menu">
                        ...
                        <li class="nav-item dropdown">
                            ...
                            <ul class="dropdown-menu">
                                <li><a class="nav-link" href="/">Daftar Tagihan</a></li>
                                <li><a class="nav-link" href="/mahasiswa/tagihan/<?= $session->get('id') ?>">Tagihan</a></li>
                                <li><a class="nav-link" href="/mahasiswa/lunas/<?= $session->get('id') ?>">Tagihan Lunas</a></li>
                            </ul>
                        </li>
                </aside>
            </div>
